...
- Optional dependencies: `apt install -y rlwrap git dos2unix default-jre htop unzip dh-autoreconf redis-server pv ack unoconv git-delta dnsutils plocate multitail hiera-eyaml`
